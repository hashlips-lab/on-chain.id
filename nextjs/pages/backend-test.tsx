        ...
        {walletIsConnected ? (
          <>
                ...
                <ul className="my-4">
                  {onChainPrivateData.map((data, index) => (
                    <li
                      ...
                      className="flex flex-col mb-4 p-2 border border-black rounded"
                    >
                      <input
              ...
              {newPrivateData.map((data, index) => (
                ...
                >
                  ...
                  <input
                    ...
                    type="text"
                    onChange={(e) =>
                      updateNewPrivateDataKey(index, keyToBytes(e.target.value))
                    }
              ...
              {allowedProviders.map((provider, index) => (
                ...
                >
                  ...
                  <button
                    className="px-2 py-1 border border-black rounded disabled:bg-red-300"
                    onClick={() =>
                      setPermissionsProviderAddressInputValue(provider)
                    }
            ...
            <input
              ...
              onChange={(e) =>
                setPermissionsProviderAddressInputValue(e.target.value)
              }
                ...
                {editablePermissions.length > 0 && (
                  <>
                    ...
                    <button
                      ...
                      disabled={
                        isWritePermissionsLoading || !permissionsChanged()
                      }
                    >
                      Save
                    </button>
            ...
            <input
              ...
              placeholder="Provider address"
              onChange={(e) =>
                setExpirationProviderAddressInputValue(e.target.value)
              }
            />
            <button
              className="px-2 py-1 border border-black rounded"
              onClick={() =>
                refreshProviderExpiration(expirationProviderAddressInputValue)
              }
            >
              Get expiration for provider
            </button>
            {providerExpiration && (
              <strong>{providerExpiration.toNumber()}</strong>
            )}
